...
public class CompletableFutureTest {
    ...
    // выполнить асинх действие без газа
    ...
    // выполнить асинх действие с газом (пример)
    ...
    // выполнить действие thenAccept() после выполнения другого асинх действия
    ...
    // выполнить действие для возращ значения thenApply после выполнения другого асинх действия
    ...
    // выполнить задачу(Runnable) после асинхр задачи
...
//    Для совмещения двух объектов ComputableFuture
//    можно использовать thenCompose(), thenCombine().
...
//    Это метод возвращает ComputableFuture<Void>, при этом обеспечивает выполнение всех задач
    ...
    //  anyOf()
// метод возвращает ComputableFuture<Object>. Результатом будет первая выполненная задача
...
//        CompletableFutureTest.runAsyncExample();
//        CompletableFutureTest.supplyAsyncExample();
//        CompletableFutureTest.thenRunExample();
//        CompletableFutureTest.thenAcceptExample();
//        CompletableFutureTest.thenApplyExample();
//        CompletableFutureTest.thenComposeExample();
//        CompletableFutureTest.thenCombineExample();
        CompletableFutureTest.anyOfExample();
    }
}
